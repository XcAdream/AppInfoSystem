...
<div class="row">
  <div class="col-md-12 col-sm-12 col-xs-12">
    <div class="x_panel">
      <div class="x_title">
        <h2>修改APP最新版本信息 <i class="fa fa-user"></i><small>${sessionScope.devUser.devname}</small></h2>
            <div class="clearfix"></div>
      </div>
      <div class="x_title">
            <h2>历史版本列表</h2>
	  ...
	  <p class="text-muted font-13 m-b-30"></p>
        ...
        <form class="form-horizontal form-label-left" action="appversionmodifysave" method="post" enctype="multipart/form-data">
           ...
           <input type="hidden" name="modifyby" id="modifyby" value="${sessionScope.devUser.id}">
