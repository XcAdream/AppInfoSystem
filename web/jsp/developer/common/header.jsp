...
<c:if test="${empty sessionScope.devUser}">
	<script>
		alert("请先登录！");location.href="${pageContext.request.contextPath}/jsp/devlogin.jsp";
	</script>
</c:if>
<!DOCTYPE html>
<html lang="en">
			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="${pageContext.request.contextPath }/my/dev/main" class="site_title"><i class="fa fa-paw"></i> <span>APP
								BMS</span>
						</a>
					</div>
						...
						<div class="menu_section">
							...
							<ul class="nav side-menu">
								...
								<li><a><i class="fa fa-edit"></i> APP应用管理<span
									...
									<ul class="nav child_menu">
										<li><a href="${pageContext.request.contextPath }/dev/applist">APP维护</a>
										</li>
									</ul></li>
							</ul>
						</div>
					...
					<div class="sidebar-footer hidden-small">
						<a data-toggle="tooltip" data-placement="top" title="Settings">
							...
							href="${pageContext.request.contextPath }/my/logout"> <span
						...
						<ul class="nav navbar-nav navbar-right">
							<li class=""><a href="javascript:;"
								...
								<ul class="dropdown-menu dropdown-usermenu pull-right">
									<li><a
										href="${pageContext.request.contextPath }/my/logout"><i
