...
<c:if test="${empty sessionScope.user}">
  <script>
    alert("请先登录！");location.href="${pageContext.request.contextPath}/jsp/backendlogin.jsp";
  </script>
</c:if>
<!DOCTYPE html>
<html lang="en">
        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="${pageContext.request.contextPath }/my/backend/main" class="site_title"><i class="fa fa-paw"></i> <span>APP BMS</span></a>
            </div>
            ...
            <div class="profile">
              ...
              <div class="profile_info">
                <span>Welcome,</span>
                <h2>${sessionScope.user.usercode }</h2>
              </div>
            </div>
            <!-- /menu profile quick info -->
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/my/logout">
              ...
              <ul class="nav navbar-nav navbar-right">
                <li class="">
                  <a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                    <img src="${pageContext.request.contextPath }/statics/images/img.jpg" alt="">${sessionScope.user.usercode }
                    <span class=" fa fa-angle-down"></span>
                  </a>
                  <ul class="dropdown-menu dropdown-usermenu pull-right">
                    <li><a href="${pageContext.request.contextPath }/my/logout"><i class="fa fa-sign-out pull-right"></i> Log Out</a></li>
                  </ul>
                </li>
